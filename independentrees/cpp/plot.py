...
# for file in ["data_beta01.csv", "data_beta05.csv", "data_beta1.csv", "data_beta15.csv", "data_beta2.csv"]:
# #for file in ["data_1.9.csv", "data_1.95.csv", "data_2.05.csv", "data_2.csv"]:
...
#     fig.add_trace(go.Scatter(x=x, y=cnts, line={"width": 5}, name=file))
...
fig.show()
fig.write_image("independent.pdf", engine="kaleido")
